...
async def main() -> None:
    ...
    agent=AssistantAgent(
        ...
        system_message="""You are a weather assistant.If the given city is valid 
        then proceed or respond as 'invalid city'.
        You must never answer outside of your scope.""",
